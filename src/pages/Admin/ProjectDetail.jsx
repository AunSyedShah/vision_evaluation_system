...
const AdminProjectDetail = () => {
  ...
  if (error) {
    return (
      <div className="text-center py-12">
        ...
        <br />
        <Link to="/admin/projects" className="text-[#ab509d] hover:text-[#ab509d] mt-4 inline-block">
          ← Back to Projects
        </Link>
      </div>
    );
  ...
  return (
    <div>
      <div className="mb-8">
        <Link to="/admin/projects" className="text-[#ab509d] hover:text-[#ab509d] mb-4 inline-block">
          ← Back to Projects
        </Link>
